...
abstract class AppLocalizations {
  ...
  /// No description provided for @loginInWithGoogle.
  ///
  /// In en, this message translates to:
  /// **'Login with Google'**
  String get loginInWithGoogle;
  ...
  /// No description provided for @pleaseEnterYourTitle.
  ///
  /// In en, this message translates to:
  /// **'Please enter your title'**
  String get pleaseEnterYourTitle;
